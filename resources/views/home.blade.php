...
<head>
    ...
    <!-- Favicon -->
    <link href="{{asset('mainassets2/img/favicon.ico')}}" rel="icon">
    ...
    <link href="{{asset('mainassets2/lib/lightbox/css/lightbox.min.css')}}" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="{{asset('mainassets2/css/bootstrap.min.css')}}" rel="stylesheet">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        <a href="index.html" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary">ids</h2>
        </a>
    ...
    <div class="container-fluid p-0 pb-5">
        <div class="owl-carousel header-carousel position-relative">
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="{{asset('mainassets2/img/carousel-1.jpg')}}" alt="">
    ...
    <script src="{{asset('mainassets2/lib/wow/wow.min.js')}}"></script>
    ...
    <script src="{{asset('mainassets2/lib/isotope/isotope.pkgd.min.js')}}"></script>
    <script src="{{asset('mainassets2/lib/lightbox/js/lightbox.min.js')}}"></script>
